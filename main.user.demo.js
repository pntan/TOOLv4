  ...
  (function() {
    ...
    const ThemPhanLoai = () => {
      ...
      openModal() {
          ...
          <div id="tpv4-modal-container" class="TPV4-fixed TPV4-inset-0 TPV4-z-[2147483647]">
            ...
            <div class="TPV4-relative TPV4-flex TPV4-flex-col TPV4-gap-4 TPV4-justify-center TPV4-items-center TPV4-h-full TPV4-w-full">
              <div class="TPV4-bg-[#1a1a1a] TPV4-p-6 TPV4-rounded-2xl TPV4-shadow-2xl TPV4-border TPV4-border-white/10 TPV4-w-[500px]">
                <p class="TPV4-text-white TPV4-font-bold TPV4-text-lg TPV4-mb-3">${this.functionName}</p>
                <textarea
        ...
        $(this.$modal).find("#TPV4-cancel").on("click", (e) => {
          $(this.$modal).hide();
        })
      }
      ...
      addShopee(data){
        console.log(data);
        var indexVarianty = 0;
        function nextVarianty(SIMULATOR){
          ...
          SIMULATOR.simulateReactInput(lastInputName, data[indexVarianty][0]);

          indexVarianty++;
          nextVarianty();
        }

        nextVarianty(this.SIMULATOR);
      }
    }
    ...
    class TPTOOL {
      constructor() {
        ...
        this.initTailwind();
        this.addTabTextarea();
        this.ThemPhanLoai = new ThemPhanLoai(this.utils, this.simulator);
      }
